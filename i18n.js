...
const translations = {
  en: {
    ...
    table_additional: "Additional Settings",
    table_conv: "File Convert & Re-encode",
    table_themes: "Custom Themes / Icons",
    table_discord: "Discord VIP Access Perks",
    additional_settings: "BlockSiteException / PaddingForOneHandException / AdsCleanerException and more",
    t_free: "Free",
    t_standard: "Standard",
    t_pro: "Pro",
    t_premium: "Premium",
    ...
    note4: "* Additional Settings and File Convert use the same eligibility rules. In the table, only check / x is shown; supported tiers can use BlockSiteException / PaddingForOneHandException / AdsCleanerException and file conversion features.",
  ...
  ja: {
    ...
    table_price: "価格",
    table_dl: "メディアダウンロード",
    table_additional: "追加設定",
    table_conv: "ファイル変換・再エンコード",
    table_themes: "カスタムテーマ / アイコン",
    table_discord: "Discord VIPアクセス",
    additional_settings: "BlockSiteException / PaddingForOneHandException / AdsCleanerException など",
    t_free: "無料",
    t_standard: "スタンダード",
    t_pro: "プロ",
    t_premium: "プレミアム",
    ...
    note4: "※追加設定とファイル変換は同じ対応条件です。表ではチェック / バツのみ表示し、対応ティアでは BlockSiteException / PaddingForOneHandException / AdsCleanerException とファイル変換機能を利用できます。",
